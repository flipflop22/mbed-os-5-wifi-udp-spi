...
#define MBED_CONF_LWIP_PBUF_POOL_BUFSIZE                                      590                                                                                              // set by application[UBLOX_EVK_ODIN_W2]
...
#define MBED_CONF_APP_WIFI_SSID                                               "RollsRoyce"                                                                                     // set by application
...
#define MBED_CONF_TARGET_STDIO_UART_TX                                        D8                                                                                               // set by target:UBLOX_EVK_ODIN_W2
...
#define MBED_CONF_IDW0XX1_EXPANSION_BOARD                                     IDW01M1                                                                                          // set by library:idw0xx1
...
#define MBED_CONF_TARGET_STDIO_UART_RX                                        D2                                                                                               // set by target:UBLOX_EVK_ODIN_W2
...
#define MBED_CONF_APP_WIFI_PASSWORD                                           "rr epsilon"                                                                                     // set by application
